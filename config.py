...
class Config:
    ...
    LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2493411028')) if environ.get('LOG_CHANNEL') else 2493411028
    FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "https://t.me/+1bS04tL1eaEzOGVl") # FORCE SUB channel link 
